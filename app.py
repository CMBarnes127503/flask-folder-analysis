...
# -------------------------------------------------
# Hard‑wired Blueprints
# -------------------------------------------------
from sss import sss_bp
app.register_blueprint(sss_bp)

from questions import questions_bp
app.register_blueprint(questions_bp)

from sports_participation import sports_bp
app.register_blueprint(sports_bp)

# -------------------------------------------------
# Folder‑based system (upload‑free)
# -------------------------------------------------
...
# -------------------------------------------------
SSS_DATASETS = {
    "sss_main": "https://raw.githubusercontent.com/CMBarnes127503/flask-folder-analysis/main/data/Data%20Set_SSS.xlsx"
}

QUESTIONS_DATASETS = {
    "questions_main": "https://raw.githubusercontent.com/CMBarnes127503/flask-folder-analysis/main/data/Full%20Data%20Set_example3__.xlsx"
}

SPORTS_DATASETS = {
    "sports_main": "https://raw.githubusercontent.com/CMBarnes127503/flask-folder-analysis/main/data/Full%20Data%20Set_example4.xlsx"
}

# -------------------------------------------------
# Folder scanning (Region + Comparative)
# -------------------------------------------------
def list_region_files():
    return [
        f for f in os.listdir(REGION_FOLDER)
...
def index():
    ...
    if request.method == "POST":
        ...
        if source == "region" and action == "analyze":
            ...
            kpi_category = request.form.get("kpi_category")

            if analysis == "KPI":
                scatter_path, bar_path = plot_kpi(filepath, kpi_category)
        ...
        if source == "compare" and action == "analyze":
            ...
            if analysis == "Overall":
                ...
                plot_file = map_path
                plot_file2 = heat_path

            elif analysis == "KPI_Summary":
